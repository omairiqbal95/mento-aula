import BlogStandardItem from "./blog-standard/BlogStandardItem";
...
import { blogStandardContent } from "@/content/inner-pages/blog-standard";

const BlogStandard = () => {
  const { blogItems, sidebar, pagination } = blogStandardContent;
      ...
      <div className="container">
        <div className="row g-4 gy-5">
          <div className="col-lg-8 fade_up_anim" data-delay=".2">
            <div className="blog__wrapper blog__wrapper--style2">
              {blogItems.map((item) => (
                <BlogStandardItem key={item.id} item={item} />
              ))}
            </div>
